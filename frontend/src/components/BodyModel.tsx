    ...
    <div id="body-model-container" className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 rounded-2xl bg-white border border-slate-100 shadow-soft-sm">
      <div className="flex flex-col items-center">
        <div className="text-center mb-1">
          ...
          <p className="text-xs text-slate-505">Tap hot-zones to activate recommended movement guides</p>
        </div>
      ...
      <div className="flex flex-col justify-between p-5 rounded-2xl bg-slate-55 border border-slate-200 shadow-inner">
        <div>
          ...
          <span className="text-xs font-bold text-slate-505 tracking-wider uppercase block mb-2">
          ...
          <div className="space-y-2">
            {selectedMuscle.exercises.map((ex, i) => (
              ...
              >
                ...
                <span className="ml-auto text-[10px] font-bold text-sky-650 flex items-center gap-0.5 bg-sky-50 px-1.5 py-0.5 rounded">
